...
namespace MyApp.Infrastructure.AI
{
    public class LlmService : ILlmService
    {
        ...
        public const string MasterSystemPrompt = 
            ...
            "Purpose: Convert one natural-language operator note into one structured energy-scheduling directive (JSON).\n\n" +
            "ROLE & OPERATIONAL BOUNDARIES:\n" +
            "You are a deterministic, zero-shot energy directive parser for a 24-hour campus microgrid.\n" +
            "Return EXACTLY one raw JSON object. No Markdown code fences, no prose.\n\n" +
            "SCHEMA:\n" +
            "{\n" +
            ...
            "  \"explanation\": string\n" +
            "}\n\n" +
            "INTERVAL RULE: Half-open interval [start, end) = { start, ..., end - 1 }.\n" +
            "FACTOR: Remaining fraction of expected solar (e.g. 20% remaining -> 0.20, 80% reduction -> 0.20, cut in half -> 0.50).";
        ...
        public class RawStructuredAdjustmentDto
        {
